...
public class Blibioteca {
    ...
    public void adicionarLivro(Livro livro) throws Exception {
        ...
        if (livro.getTitulo() == null || livro.getTitulo().isEmpty()) {
            throw new Exception("Digite um titulo,é obrigatório");
        }
        if (livro.getAutor() == null || livro.getAutor().isEmpty()) {
            throw new Exception("DIgite um autor, é obrigatório");
        }
        acervo.add(livro);
    }
    ...
    public void cadastrar(Scanner scan) {
        ...
        while (!anoValido) {
            ...
            if (scan.hasNextInt()) {
                ...
                System.out.println("Ano inválido. Insira um número inteiro.");
                scan.next();
            }
        }
        scan.nextLine();
        ...
        while (!paginasValidas) {
            ...
            if (scan.hasNextInt()) {
                ...
                System.out.println("Número de páginas inválido. Insira um número inteiro.");
                scan.next();
            }
        }
        scan.nextLine();
    ...
    public void pesquisarLivro(String titulo) {
        ...
        if (livrosEncontrados.isEmpty()) {
            System.out.println("Nenhum livro cadastrado com esse título: " + titulo);
        } else {
